        ...
        try {
            ...
            if (response.ok) {
                ...
                if (refreshResponse.ok) {
                    ...
                    console.error("Refresh Token Fialed");
                }
            } else {
    ...
    return (
        <div className="text-center pt-36">
            ...
            <p className="text-gray-300 text-center">
                All that you need to KickStart your Carrer.
            </p>
            <div className="flex flex-wrap justify-center gap-8 py-12 mx-auto">
                ...
                {courses.map((course) => (
                    <div
                        key={course.id}
                        className="flex flex-col items-stretch rounded overflow-hidden shodow-md shadow-green-300/35 pb-4 bg-[#001313]"
                    >
                        <img
                        ...
                        <div className="px-6 py-4 flex-grow">
                            ...
                            <div className="flex justify-center items-center gap-2" >
                                ...
                                <div className="text-gray-200 text-lg border border-green-300  rounded-full px-4 py-1">
                                    ${course.price}
                                </div>
