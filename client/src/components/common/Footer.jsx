...
export default function Footer() {
    return (
        <footer
        className="mx-auto py-14 flex justify-center items-center"
        >
            <div className="mx-auto">
                <ul className="text-lg flex items-center justify-center flex-col gap-8 md:flex-row
                md:gap-24 transition-all duration-500 py-16 mb-10 border-b border-gray-200">
                    <Link 
                    to="/"
                    ...
                    <Link
                    to="/blogs"
                    className="text-md leading-6 text-100"
                    >
                        Blogs
                    </Link>
                ...
                <div className="flex space-x-10 justify-center items-center mb-14">
                  ...
                  fill="currentColor"
                    ...
                    <Link
                    to="/"
                    className="block text-gray-100 transition-all duation-500 hover:text-green-300"
                    >
                        <svg
